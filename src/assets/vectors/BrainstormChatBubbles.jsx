...
const CostChatBubbles = ({ color, ...rest }) => (
  ...
  >
    ...
    <path
      style={{ fill: "#F4A200" }}
      d="M512,256c0-3.977-0.103-7.93-0.283-11.862l-97.995-98.225L188.931,306.55l-90.596,36.076
	l169.918,169.076C403.947,505.306,512,393.276,512,256z"
    />
    <path
      style={{ fill: "#F1543F" }}
      d="M404.858,142.222H224.321c-6.942,0-12.569,5.627-12.569,12.569v98.266
    ...
    <path
      style={{ fill: "#D83E20" }}
      d="M404.858,142.222h-90.819v123.404h29.22l33.032,33.032v-33.032h28.567
	c6.942,0,12.569-5.627,12.569-12.569v-98.266C417.427,147.849,411.8,142.222,404.858,142.222z"
    />
    <path
      style={{ fill: "#F4E3C3" }}
      d="M107.308,222.96h180.536c6.942,0,12.569,5.627,12.569,12.569v98.268
    ...
    <path
      style={{ fill: "#FED8B2" }}
      d="M287.846,222.96h-96.778v123.404h96.778c6.942,0,12.569-5.627,12.569-12.569v-98.268
	C300.413,228.586,294.786,222.96,287.846,222.96z"
    />
    <circle style={{ fill: "#324A5E" }} cx="256" cy="227.556" r="56.889" />
    <path
      style={{ fill: "#2B3B4E" }}
      d="M256,170.667c-0.384,0-0.765,0.021-1.148,0.029v113.719c0.383,0.007,0.764,0.029,1.148,0.029
	c31.418,0,56.889-25.471,56.889-56.889S287.418,170.667,256,170.667z"
    />
    <path
      style={{ fill: "#FFC61B" }}
      d="M245.319,261.834c-1.034,0-2.079-0.315-2.981-0.974c-2.255-1.648-2.748-4.811-1.098-7.066
    ...
    <path
      style={{ fill: "#EAA22F" }}
      d="M266.676,222.499h-11.393l15.476-21.178c1.648-2.255,1.157-5.42-1.098-7.066
